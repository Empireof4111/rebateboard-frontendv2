...
import { TrendingUp, TrendingDown, ArrowDown, ArrowUp, AlertTriangle, Info } from "lucide-react";
...
export function InsightCard({ insight }: { insight: TrtInsight }) {
  const map = {
    positive: { icon: TrendingUp, bg: "bg-success/10 ring-success/25", chip: "bg-success/20 text-success", chipText: "Win" },
