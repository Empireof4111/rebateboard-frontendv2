...
function buildModuleIndex(): Hit[] {
  ...
  const modules = [
    ...
    ["Search Analytics", "/superadmin/search-analytics"],
    ...
    ["TBI Management", "/superadmin/tbi"],
    ["Brand Management", "/superadmin/brands"],
    ["Brand Applications", "/superadmin/brand-requests"],
    ["Payout Verification", "/superadmin/payouts"],
    ...
    ["Cashback Claims", "/superadmin/claims"],
    ["RR Ledger", "/superadmin/wallet"],
    ["Rebate Rewards", "/superadmin/rr"],
    ["Reviews", "/superadmin/reviews"],
    ["Landing Testimonials", "/superadmin/reviews?view=testimonials"],
    ["Add Brand", "/superadmin/brands/new"],
    ["Blog & News", "/superadmin/blog"],
    ["Company News", "/superadmin/news"],
    ["Homepage Videos", "/superadmin/homepage-videos"],
    ["FAQs", "/superadmin/faqs"],
    ["Announcements", "/superadmin/announcements"],
    ["Pop-ups", "/superadmin/popups"],
    ["Offers", "/superadmin/offers"],
    ["Offers & Discounts", "/superadmin/offers"],
    ["Dashboard Ads", "/superadmin/ads"],
    ...
    ["Cashback Calculator", "/superadmin/cashback-calculator"],
    ["ROI Tracker", "/superadmin/trt"],
    ["AI Backtest Lab", "/superadmin/backtest"],
    ["Top Sellers", "/superadmin/top-sellers"],
    ["Leaderboards", "/superadmin/leaderboards"],
    ["Academy", "/superadmin/academy"],
    ["Subscribers", "/superadmin/subscribers"],
    ["Affiliates / IB", "/superadmin/affiliates"],
    ["Partner Requests", "/superadmin/partner-requests"],
  ...
  modules.forEach(([label, to]) => hits.push({ id: `m-${to}-${label}`, label, sub: "Open module", group: "Navigate", to }));
  return hits;
}
