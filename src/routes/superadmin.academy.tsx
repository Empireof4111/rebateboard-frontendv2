...
import {
  ...
  RotateCcw, Search, Eye, FileQuestion, PlayCircle,
    ...
    <div className="space-y-4">
      ...
      {(course.outcomes ?? []).length > 0 && (
        <div className="rounded-xl bg-white/5 p-4 ring-1 ring-white/10">
          <div className="mb-2 text-xs font-bold text-white inline-flex items-center gap-1.5"><BookOpen className="h-3 w-3 text-violet-300" /> What you'll learn</div>
