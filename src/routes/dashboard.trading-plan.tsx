...
function ProfileTab() {
  ...
  return (
    <Panel title="Trader Profile" action={<Brain className="h-4 w-4 text-violet-300" />}>
...
function RulesTab() {
  ...
  return (
    <Panel title="Trading Rules" action={<Shield className="h-4 w-4 text-violet-300" />}>
      <div className="grid gap-3 md:grid-cols-2">
...
function PsychologyTab() {
  ...
  return (
    <Panel title="Psychology Rules" action={<Brain className="h-4 w-4 text-violet-300" />}>
      <div className="grid gap-3 md:grid-cols-2">
...
function ChecklistTab() {
  ...
  return (
    <Panel title="Pre-trade Checklist" action={<ListChecks className="h-4 w-4 text-violet-300" />}>
