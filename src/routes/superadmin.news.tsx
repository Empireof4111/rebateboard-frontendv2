      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <button onClick={() => setEditing(emptyItem())} className="inline-flex items-center gap-1.5 rounded-full rb-gradient-primary px-3 py-1.5 text-xs font-semibold text-white">
        ...
        <Modal
          ...
          footer={
            <>
              ...
              <button onClick={save} disabled={saving || !editing.title.trim()} className="rounded-xl rb-gradient-primary px-4 py-2 text-xs font-bold text-white disabled:opacity-40">
                {saving ? "Saving…" : "Save"}
              </button>
            </>
          }
