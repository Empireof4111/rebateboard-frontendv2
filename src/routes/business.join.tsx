...
function BusinessJoinPage() {
    ...
    return (
      <div className="min-h-screen bg-[var(--rb-bg-canvas)] text-foreground">
        ...
        <main className="container-app py-8 sm:py-10">
          <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-900/30 via-violet-900/10 to-[#0b0418] p-8 text-center md:p-14">
            <div className="absolute inset-x-16 top-0 h-40 rounded-full bg-violet-500/20 blur-3xl" />
            <div className="relative mx-auto max-w-2xl">
              <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl border border-white/10 bg-white/10 text-violet-200 shadow-[0_0_34px_rgba(192,132,252,0.22)]">
                <Shield className="h-6 w-6" />
              </div>
              <div className="mt-5 text-[11px] font-semibold uppercase tracking-[0.24em] text-violet-200/80">Brand Applications</div>
              ...
              <div className="mt-7 flex flex-wrap justify-center gap-3">
                <Link to="/contact" className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-3 text-sm font-semibold text-white transition hover:border-violet-300/40">
                  <Bell className="h-4 w-4 text-violet-200" /> Notify Me
                </Link>
  ...
  return (
    <div className="min-h-screen bg-[var(--rb-bg-canvas)] text-foreground">
      ...
      <main className="container-app py-8 sm:py-10">
        {/* HERO */}
        <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-violet-900/30 via-violet-900/10 to-[#0b0418] p-8 md:p-12">
          ...
          <div className="relative grid gap-10 md:grid-cols-[1.4fr_1fr] md:items-center">
            <div>
              ...
              <h1 className="mt-4 text-4xl font-bold leading-tight md:text-6xl">
                Build your <span className="bg-gradient-to-r from-violet-400 to-violet-300 bg-clip-text text-transparent">Trust Profile</span>
              </h1>
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-[0_24px_70px_rgba(76,29,149,0.26)]">
                ...
                <div className="relative">
                  <div className="flex items-center justify-between gap-3">
                    <div>
                      <div className="text-[10px] font-semibold uppercase tracking-[0.22em] text-violet-200/70">Trust Profile Preview</div>
                      <div className="mt-1 text-lg font-bold text-white">Preliminary profile</div>
                    </div>
                    <div className="grid h-10 w-10 place-items-center rounded-2xl border border-white/10 bg-white/10 text-violet-200">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4 text-xs">
                ...
                <ol className="mt-2 space-y-1.5 text-muted-foreground">
                  <li className="flex gap-2">
                    <span className="grid h-5 w-5 shrink-0 place-items-center rounded-full bg-violet-400/15 text-[10px] font-bold text-violet-200">1</span>
                    <span>Submit data → <span className="text-violet-300">Preliminary score</span></span>
                  </li>
                  <li className="flex gap-2">
        ...
        <section className="mt-10 grid gap-4 md:grid-cols-4">
          {BENEFITS.map((b) => {
            const Icon = b.icon;
            return (
              <div key={b.title} className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-sm transition hover:border-violet-400/30">
        ...
        <section id="categories" className="mt-12 scroll-mt-24">
          <div className="mb-5">
            <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-300/80">Choose your category</div>
            ...
            {(Object.keys(CATEGORY_META) as BrandCategory[]).map((cat) => {
              ...
              return (
                <Link
                  ...
                  params={{ category: cat }}
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-5 transition hover:border-violet-400/40 hover:shadow-[0_0_28px_rgba(192,132,252,0.18)]"
                >
                  <div className="text-3xl">{meta.emoji}</div>
                  <div className="mt-3 text-lg font-bold">{meta.label}</div>
                  <p className="mt-1 text-xs text-muted-foreground">{meta.tagline}</p>
                  <div className="mt-4 inline-flex items-center gap-1 text-xs font-semibold text-violet-300">
        ...
        <section className="mt-12 rounded-3xl border border-white/10 bg-white/[0.02] p-8 md:p-10">
          <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-violet-300/80">The process</div>
