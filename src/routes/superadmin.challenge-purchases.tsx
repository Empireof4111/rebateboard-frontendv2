...
import { Coins, Download, ExternalLink, Funnel, Search, Gift, Trophy } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_1fr_0.9fr]">
        ...
        <Panel title="Reward Preference Mix" action={<Gift className="h-3.5 w-3.5 text-violet-300" />}>
          {rows.length === 0 ? (
            <EmptyPanelText />
          ) : (
            <div className="space-y-3">
