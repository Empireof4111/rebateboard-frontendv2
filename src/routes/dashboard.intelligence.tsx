...
import { AlertTriangle, Target, WalletCards } from "lucide-react";
...
function IntelligencePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Panel title="Your Weakest Area" action={<Pill tone={journal.violations > 0 ? "warning" : "primary"}>Journal</Pill>}>
          {trades.length ? (
            ...
            <EmptyState icon={Target} title="Not enough journal data" description="Log trades to identify repeatable strengths and execution gaps." />
          )}
        </Panel>
      ...
      <Panel title="Cashback summary" action={<WalletCards className="h-4 w-4 text-violet-300" />}>
